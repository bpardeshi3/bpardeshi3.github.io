...
- **Svalinn: Overload Control in Large-Scale Servers with Multiple Resource Bottlenecks**<br>
  ...
  [USENIX OSDI 2026](https://www.usenix.org/conference/osdi26) \[[Abstract](#abstract-svalinn)\] \[[Paper]()\] \[[Code]()\]

  <details id="abstract-svalinn" style="margin-top: 8px; margin-bottom: 10px;">
    <summary style="cursor: pointer; color: #0366d6;">Abstract</summary>
...
- **CoreSync: A Protocol for Joint Core Scheduling and Overload Control of μs-Scale Tasks**<br>
  ...
  [IEEE ICNP 2025](https://ieeeicnp2025.pages.dev/) \[[Abstract](#abstract-coresync)\] \[[Paper](assets/coresync-icnp25.pdf)\] \[[Code](https://github.com/GT-ANSR-Lab/CoreSync)\]

  <details id="abstract-coresync" style="margin-top: 8px; margin-bottom: 10px;">
    <summary style="cursor: pointer; color: #0366d6;">Abstract</summary>
    <div style="margin-top: 8px; text-align: justify;">
